//
//  ConfirmationWisepadButtoniPad.swift
//  iAcepta
//
//  Created by QUALITY on 10/17/19.
//  Copyright © 2019 Quality & Knowledge. All rights reserved.
//

import UIKit

class ConfirmationWisepadButtoniPad: UIView {
    ...
    override init(frame: CGRect) {
        ...
        private func commonInit(){
            Bundle.main.loadNibNamed("ConfirmationWisepadButtoniPad", owner: self, options: nil)
            addSubview(view)
